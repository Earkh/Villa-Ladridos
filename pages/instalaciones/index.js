...
import stylesInstalaciones from '../../styles/Instalaciones.module.css';
...
export default function Instalaciones() {
  ...
  return (
    <div>
      ...
      <div className={`${stylesContainer.container} ${styles.main__presentation__text}`}>
        <h1>Instalaciones</h1>
        <p>
          En Villa Ladridos contamos con unas amplias instalaciones donde tu mejor amigo puede correr y jugar.
        </p>
        <p>
          Nuestros espaciosos jardines cuentan con zonas de sombra y fuentes de agua para que tu mascota se sienta fresca
      ...
      <div className={stylesInstalaciones.carousel__bg}>
        <div className={stylesInstalaciones.carousel}>
